...
<div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-6">
                    <h1 class="dashboard-title">Admins</h1>
                </div>
                    ...
                    <div class="row">
                       ...
                       <div class="col-6">
                            <div class="form-check form-check-inline form-input">
                                <input class="form-check-input" type="checkbox" checked="" disabled="" id="Admin" name="admin" value="1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-check form-check-inline form-input">
                                <input class="form-check-input admin_checkbox" type="checkbox" id="Admin_edit" name="admin" value="1" disabled="">
                           ...
                           $.ajax({
                            ...
                            success:function(response)
                            {
                              ...
                              if(response.success==true){
                                ...
                                $('.item'+response.data.id).replaceWith(`<tr class='item${response.data.id}'><td>${response.data.name}</td><td>${response.data.email}</td><td class="verified_status${response.data.id}"><span class="acceptStatus"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" fill="none" viewBox="0 0 16 16">
                                                                <path fill="#6FCF97" fill-rule="evenodd"
                                                                    d="M13.805 4.329c.26.26.26.682 0 .942L6.47 12.605a.667.667 0 01-.942 0L2.195 9.27a.667.667 0 11.943-.942L6 11.19l6.862-6.861c.26-.26.682-.26.943 0z"
                                                            ...
                                                            Registered</span></td><td class="actionBtn text-center"> <button  onclick='viewUser(${response.data.id})'><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" fill="none" viewBox="0 0 24 24">
                                                                <path fill="#BDBDBD"
                                                                    d="M21.92 11.6C19.9 6.91 16.1 4 12 4s-7.9 2.91-9.92 7.6a1 1 0 000 .8C4.1 17.09 7.9 20 12 20s7.9-2.91 9.92-7.6a1 1 0 000-.8zM12 18c-3.17 0-6.17-2.29-7.9-6C5.83 8.29 8.83 6 12 6s6.17 2.29 7.9 6c-1.73 3.71-4.73 6-7.9 6zm0-10a4 4 0 100 8 4 4 0 000-8zm0 6a2 2 0 110-4 2 2 0 010 4z" />
                                                            </svg>
