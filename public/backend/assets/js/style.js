...
$('#smCloseNav').on('click', function () {

    if ($('.main-section').hasClass('active') !== true) {

        if ($('.sidebar, .smd-overlay').hasClass('active') !== true) {
            $('.sidebar, .smd-overlay').addClass('active')
        }
        else {
            $('.sidebar, .smd-overlay').removeClass('active')
        }
...
$('.smd-overlay').on('click', function() {
    $(`#${sidbarMenuId}`).removeClass('active');
    $('.main-section, .sidebar, .smd-overlay').removeClass('active')
})